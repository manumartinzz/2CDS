// Espera o DOM carregar completamente antes de criar os ícones
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Criar ícones do Lucide com pequeno delay para garantir carregamento
    setTimeout(() => {
        if (typeof lucide !== 'undefined') {
            lucide.createIcons();
            console.log('✅ Ícones Lucide carregados com sucesso');
        } else {
            console.error('❌ Lucide não foi carregado');
        }
    }, 300);
